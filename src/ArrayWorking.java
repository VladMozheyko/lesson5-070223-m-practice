...
Вставка
Удаление элемента
Удаление и стирание всего массива
Поиск
Сортировка
Отображение на консоль
 */
public class ArrayWorking {
    private int[] arr = new int[5];                 // Создаем массив с 5 элементами
    ...
    public void add(int value){
        if(count > arr.length*0.8){                 // Проверяем, если в массиве элементы занимают более 80% места, выделяем ноаую память
            ...
            int[]temp = arr;                          // Копируем старый массив
            arr = new int[arr.length*2];            // Удваиваем память в текущем массиву
